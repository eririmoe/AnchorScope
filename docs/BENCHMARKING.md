...
This benchmark establishes deterministic algorithmic correctness for the represented error model. It does not establish biological sensitivity or specificity. A manuscript must add independent aligner comparison, curated real-read truth, multiple protocols and chemistries, and resource measurements on the publication compute environment.
